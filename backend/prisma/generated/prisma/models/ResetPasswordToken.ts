...
export type ResetPasswordTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"token" | "createdAt" | "expiresAt" | "userId", ExtArgs["result"]["resetPasswordToken"]>
...
export interface ResetPasswordTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const resetPasswordTokenWithTokenOnly = await prisma.resetPasswordToken.findMany({ select: { token: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ResetPasswordTokens and only return the `token`
   * const resetPasswordTokenWithTokenOnly = await prisma.resetPasswordToken.createManyAndReturn({
   *   select: { token: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ResetPasswordTokens and only return the `token`
   * const resetPasswordTokenWithTokenOnly = await prisma.resetPasswordToken.updateManyAndReturn({
   *   select: { token: true },
   *   where: {
   *     // ... provide filter here
   *   },
