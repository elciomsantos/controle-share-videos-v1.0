...
There are plenty of settings you can adjust to your needs. Controle-share-videos can be configured in two ways:
...
| `DATABASE_URL`   | `file:../data/controle-share-videos.db?connection_limit=1` | The URL of the SQLite database.                                                                          |
...
Environment variables that are only available when running Controle-share-videos with Docker.
