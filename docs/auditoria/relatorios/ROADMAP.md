...
| ~~Migrar SQLite → banco concorrente (PostgreSQL) quando o volume exigir~~ ⚠️ **Rejeitado 2026-08-10** — banco permanece SQLite (`better-sqlite3`) | `ARCHITECTURE_REVIEW.md` | P3 |
...
| ~~Suporte oficial a multi-instância / armazenamento S3~~ ⚠️ **Rejeitado 2026-08-10** — armazenamento apenas local; S3 já removido do código | `ARCHITECTURE_REVIEW.md` | P3 |
