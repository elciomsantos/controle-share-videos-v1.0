export default {
  ...
  "admin.users.table.status.active": "Ativo",
  "admin.users.table.status.inactive": "Inativo",
  "admin.users.toggle.activate": "Ativar usuário",
  "admin.users.toggle.deactivate": "Desativar usuário",
  "admin.users.deactivate.title": "Desativar usuário {username}?",
  "admin.users.deactivate.description": "O usuário não poderá mais entrar no sistema, mas seus compartilhamentos e registros de auditoria serão mantidos.",
  "admin.users.activate.title": "Ativar usuário {username}?",
  "admin.users.activate.description": "O usuário voltará a poder entrar no sistema.",
  "admin.users.notify.deactivate.success": "Usuário desativado com sucesso",
  "admin.users.notify.activate.success": "Usuário ativado com sucesso",
